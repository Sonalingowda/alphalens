# AlphaLens Runtime Assessment Policy v1.0.1
...
**Approval authority:** AlphaLens project owner, POLICY-003A
...
| `detection.persisted_inputs_verified`, `detection.ema12_below_ema26`, `detection.rsi_le_45` | `true` | `sell_threshold_met` | `SELL` |
